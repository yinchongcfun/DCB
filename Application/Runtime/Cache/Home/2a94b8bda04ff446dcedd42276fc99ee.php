...
<link rel="stylesheet" href="<?php echo (ADMIN_CSS_URL); ?>Amazecss/amazeui.min.css"/>
<link rel="stylesheet" href="<?php echo (ADMIN_CSS_URL); ?>Amazecss/css/admin.css">
<script src="<?php echo (ADMIN_CSS_URL); ?>Amazejs/jquery.min.js"></script>
...
<script src="<?php echo (ADMIN_CSS_URL); ?>Amazejs/polyfill/rem.min.js"></script>
<script src="<?php echo (ADMIN_CSS_URL); ?>Amazejs/polyfill/respond.min.js"></script>
<script src="<?php echo (ADMIN_CSS_URL); ?>Amazejs/amazeui.legacy.js"></script>
<![endif]--> 

<!--[if (gte IE 9)|!(IE)]><!--> 
<script src="<?php echo (ADMIN_CSS_URL); ?>Amazejs/amazeui.min.js"></script>
<!--<![endif]-->
